...
**evaluation harness** (calibration, completeness, conversation, groundedness, language-parity, multilingual, refusal, safety, toxicity-coverage)<!-- claim:datacard-eval-suite-names -->. A RAG system and
...
2. **Feeding the eval harness.** The 9 suites<!-- claim:datacard-eval-suite-count --> author gold cases *against these passages*; the citation/safety/parity checks
